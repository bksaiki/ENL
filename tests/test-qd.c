...
int main()
{
    ...
    {   // 4-function
        ...
        res = (r->data[0] == 5.8598744820488387 && r->data[1] == -1.7705984076240228e-16 &&
               r->data[2] == -5.1224869177565164e-33 && r->data[3] == 0.0);
        str = qd_get_str(r, 0);
        ...
        res = (r->data[0] == 0.42331082513074803 && r->data[1] == -2.2100009258189695e-17 &&
               r->data[2] == -8.670527016801629e-34 && r->data[3] == 0.0);
        str = qd_get_str(r, 0);
        if (!res) printf("FAILED \"PI - E\": %s\n", str);
        free(str);
    ...
    {   // sqrt
        ...
        res = (r->data[0] == 1.7724538509055161 && r->data[1] == -7.6665864998257987e-17 &&
               r->data[2] == -1.3058334907945429e-33 && r->data[3] == 0.0);
        str = qd_get_str(r, 0);
        ...
        res = (r->data[0] == 1.0000000000000001e+50 && r->data[1] == -6.8346252856038912e+33 &&
               r->data[2] == 48263607927321032 && r->data[3] == 0.0);
        str = qd_get_str(r, 0);
    ...
    {   // exp
        ...
        res = (r->data[0] == 23.14069263277927 && r->data[1] == -1.3488747091995788e-15 &&
               r->data[2] == -2.9023466929581629e-32 && r->data[3] == -2.2913497103421474e-48);
        str = qd_get_str(r, 0);
        ...
        res = (r->data[0] == 2.6881171418161356e+43 && r->data[1] == -1.6101271449201627e+27 &&
               r->data[2] == -101381290641.22597 && r->data[3] == -1.9205412476980537e-06);
        str = qd_get_str(r, 0);
    ...
    {   // log
        ...
        res = (r->data[0] == 1.1447298858494002 && r->data[1] == 1.0265951162707826e-17 &&
               r->data[2] == -1.3722612652165882e-34 && r->data[3] == 0.0);
        str = qd_get_str(r, 0);
        ...
        res = (r->data[0] == 230.25850929940458 && r->data[1] == -1.1033518306311232e-14 &&
               r->data[2] == -4.5381475487706814e-32 && r->data[3] == -1.674617819799971e-48);
        str = qd_get_str(r, 0);
    ...
    {   // pow
        ...
        res = (r->data[0] == 22.459157718361045 && r->data[1] == 7.8681027359723335e-16 &&
               r->data[2] == 3.2133972257502055e-32 && r->data[3] == 3.1633267635807896e-49);
        str = qd_get_str(r, 0);
        if (!res) printf("FAILED \"PI^E\": %s\n", str);
        free(str);
        ...
        qd_pow(r, y, x);
        res = (r->data[0] == 23.14069263277927 && r->data[1] == -1.3488747091995788e-15 &&
               r->data[2] == -2.9023466929582253e-32 && r->data[3] == 6.7995167650823336e-52);
        str = qd_get_str(r, 0);
        if (!res) printf("FAILED \"E^PI\": %s\n", str);
        free(str);
    }
